...
myfont = pygame.font.SysFont('helvitica', 30)
textsurface = myfont.render('Your score:', False, (0, 0, 0))
...
#####score
    score = str(round(time.time()- score1,2))
    textsurface = myfont.render("Your score:" + score, False, (0, 0, 0))
            ...
            if pygame.Rect.colliderect(player,enemy):
                if extralife == True:
                    ...
                    with open("testfile.txt","a") as f:
                        f.write(input("what is your name?")+ ": " + score + "\n")
